...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      "search_places_to_add": "Search places to add...",
      "available_places": "Available Places",
      "no_places_selected": "No places selected yet",
      "no_places_available": "No more places available",
      "max_7_places": "Maximum 7 places allowed",
      "add": "Add",
      "save": "Save",
      "cancel": "Cancel",
      "delete": "Delete",
      "delete_journey": "Delete Journey",
      "confirm_delete_journey": "Are you sure you want to delete this journey?",
      "entry_added_successfully": "Journey added successfully",
      "entry_updated_successfully": "Journey updated successfully",
      "entry_deleted_successfully": "Journey deleted successfully",
      "results_found": "results found",
      "no_entries_found": "No journeys found",
      "journeys_coming_soon": "No journeys yet",
      "journeys_wire_placeholder": "Create your first journey",
      "arabic": "Arabic",
      "french": "French",
      "english": "English",
    ...
    'ar': {
      "journeys": "الرحلات",
      "add_journey": "إضافة رحلة جديدة",
      "edit_journey": "تعديل الرحلة",
      "search_journeys": "ابحث في الرحلات...",
      "name_ar": "الاسم بالعربية",
      "name_fr": "الاسم بالفرنسية",
      "description_ar": "الوصف بالعربية",
      "description_fr": "الوصف بالفرنسية",
      "description_en": "الوصف بالإنجليزية",
      "selected_places": "الأماكن المختارة",
      "add_places": "إضافة أماكن",
      "search_places_to_add": "ابحث عن أماكن للإضافة...",
      "available_places": "الأماكن المتاحة",
      "no_places_selected": "لم يتم اختيار أي أماكن بعد",
      "no_places_available": "لا توجد أماكن متاحة أخرى",
      "max_7_places": "الحد الأقصى 7 أماكن",
      "add": "إضافة",
      "save": "حفظ",
      "cancel": "إلغاء",
      "delete": "حذف",
      "delete_journey": "حذف الرحلة",
      "confirm_delete_journey": "هل أنت متأكد من حذف هذه الرحلة؟",
      "entry_added_successfully": "تمت إضافة الرحلة بنجاح",
      "entry_updated_successfully": "تم تحديث الرحلة بنجاح",
      "entry_deleted_successfully": "تم حذف الرحلة بنجاح",
      "results_found": "نتيجة",
      "no_entries_found": "لم يتم العثور على أي رحلات",
      "journeys_coming_soon": "لا توجد رحلات بعد",
      "journeys_wire_placeholder": "أنشئ رحلتك الأولى",
    ...
    'fr': {
      "journeys": "Parcours",
      "add_journey": "Ajouter un parcours",
      "edit_journey": "Modifier le parcours",
      "search_journeys": "Rechercher des parcours...",
      ...
      "selected_places": "Lieux sélectionnés",
      "add_places": "Ajouter des lieux",
      "search_places_to_add": "Rechercher des lieux à ajouter...",
      "available_places": "Lieux disponibles",
      "no_places_selected": "Aucun lieu sélectionné pour le moment",
      "no_places_available": "Aucun autre lieu disponible",
      "max_7_places": "Maximum 7 lieux autorisés",
      "add": "Ajouter",
      "save": "Enregistrer",
      "cancel": "Annuler",
      "delete": "Supprimer",
      "delete_journey": "Supprimer le parcours",
      "confirm_delete_journey": "Êtes-vous sûr de vouloir supprimer ce parcours ?",
      "entry_added_successfully": "Parcours ajouté avec succès",
      "entry_updated_successfully": "Parcours mis à jour avec succès",
      "entry_deleted_successfully": "Parcours supprimé avec succès",
      "results_found": "résultats trouvés",
      "no_entries_found": "Aucun parcours trouvé",
      "journeys_coming_soon": "Aucun parcours pour le moment",
      "journeys_wire_placeholder": "Créez votre premier parcours",
