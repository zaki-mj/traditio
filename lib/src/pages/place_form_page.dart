...
class _PlaceFormPageState extends State<PlaceFormPage> {
  ...
  void initState() {
    ...
    _ratingController = TextEditingController(
      text: place?.rating.toString() ?? '4.0',
    );
  ...
  void _savePlace() {
    ...
    Place(
      ...
      imageUrl: _imageUrlController.text.isNotEmpty
          ...
          : 'https://picsum.photos/seed/${_nameController.text.replaceAll(' ', '_')}/600/400',
      rating: rating,
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items:
                        ['hotel', 'restaurant', 'attraction', 'store', 'other']
                            .map(
                              (type) => DropdownMenuItem(
                                value: type,
                                child: Text(loc.translate('type_$type')),
                              ),
                            )
                            .toList(),
                    onChanged: (value) {
